...
{
    public class HcmWorkerEntityVocabulary : SimpleVocabulary
    {
        public HcmWorkerEntityVocabulary()
        {
            VocabularyName = "Common Data Model HcmWorkerEntity";
            KeyPrefix = "commonDataModel.hcmworkerentity";
            KeySeparator = ".";
            Grouping = "/HcmWorkerEntity";

            AddGroup("Common Data Model HcmWorkerEntity Details", group =>
            {
...
AddressPurpose = group.Add(new VocabularyKey(nameof(AddressPurpose), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
WorkerStatus = group.Add(new VocabularyKey(nameof(WorkerStatus), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
public VocabularyKey AddressPurpose { get; private set; }
...
public VocabularyKey WorkerStatus { get; private set; }
