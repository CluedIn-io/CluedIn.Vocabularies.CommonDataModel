...
{
    public class SalesOrderHeaderV2EntityVocabulary : SimpleVocabulary
    {
        public SalesOrderHeaderV2EntityVocabulary()
        {
            VocabularyName = "Common Data Model SalesOrderHeaderV2Entity";
            KeyPrefix = "commonDataModel.salesorderheaderv2entity";
            KeySeparator = ".";
            Grouping = "/SalesOrderHeaderV2Entity";

            AddGroup("Common Data Model SalesOrderHeaderV2Entity Details", group =>
            {
...
RevRecFollowOriginalPricingMethod = group.Add(new VocabularyKey(nameof(RevRecFollowOriginalPricingMethod), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
public VocabularyKey RevRecFollowOriginalPricingMethod { get; private set; }
