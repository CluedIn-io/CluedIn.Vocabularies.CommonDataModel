...
{
    public class JmgManufacturingExecutionProductionOrderDefaultsEntityVocabulary : SimpleVocabulary
    {
...
PieceworkRateCalculationFormula = group.Add(new VocabularyKey(nameof(PieceworkRateCalculationFormula), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
ProductionOrderSchedulingGranularity = group.Add(new VocabularyKey(nameof(ProductionOrderSchedulingGranularity), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
public VocabularyKey ProductionOrderSchedulingGranularity { get; private set; }
