...
{
    public class RetailTransactionBankedTenderTransEntityVocabulary : SimpleVocabulary
    {
        public RetailTransactionBankedTenderTransEntityVocabulary()
        {
            VocabularyName = "Common Data Model RetailTransactionBankedTenderTransEntity";
            KeyPrefix = "commonDataModel.retailtransactionbankedtendertransentity";
            KeySeparator = ".";
            Grouping = "/RetailTransactionBankedTenderTransEntity";

            AddGroup("Common Data Model RetailTransactionBankedTenderTransEntity Details", group =>
            {
...
BankBagNumber = group.Add(new VocabularyKey(nameof(BankBagNumber), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
BankedStatusType = group.Add(new VocabularyKey(nameof(BankedStatusType), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
public VocabularyKey BankBagNumber { get; private set; }
...
public VocabularyKey BankedStatusType { get; private set; }
