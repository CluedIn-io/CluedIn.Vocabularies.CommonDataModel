...
{
    public class TransTaxInformationEntityVocabulary : SimpleVocabulary
    {
        public TransTaxInformationEntityVocabulary()
        {
            VocabularyName = "Common Data Model TransTaxInformationEntity";
            KeyPrefix = "commonDataModel.transtaxinformationentity";
            KeySeparator = ".";
            Grouping = "/TransTaxInformationEntity";

            AddGroup("Common Data Model TransTaxInformationEntity Details", group =>
            {
...
TransitDocumentType = group.Add(new VocabularyKey(nameof(TransitDocumentType), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
TransactionRecId = group.Add(new VocabularyKey(nameof(TransactionRecId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
TransactionTableId = group.Add(new VocabularyKey(nameof(TransactionTableId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
public VocabularyKey TransitDocumentType { get; private set; }
public VocabularyKey TransactionRecId { get; private set; }
public VocabularyKey TransactionTableId { get; private set; }
