...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class WHSWarehouseLocationDirectiveLineUnitOfMeasureRestrictionEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "WHS Warehouse Location Directive Line Unit Of Measure Restriction Entity";
            ...
            AddGroup("WHSWarehouseLocationDirectiveLineUnitOfMeasureRestrictionEntity Details", group =>
            {
