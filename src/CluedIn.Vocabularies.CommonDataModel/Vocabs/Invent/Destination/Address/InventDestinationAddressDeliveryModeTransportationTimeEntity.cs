...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class InventDestinationAddressDeliveryModeTransportationTimeEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Invent Destination Address Delivery Mode Transportation Time Entity";
            ...
            AddGroup("InventDestinationAddressDeliveryModeTransportationTimeEntity Details", group =>
            {
