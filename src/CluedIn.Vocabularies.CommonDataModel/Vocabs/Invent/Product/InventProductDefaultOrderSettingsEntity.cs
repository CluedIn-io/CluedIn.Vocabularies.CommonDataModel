...
{
    public class InventProductDefaultOrderSettingsEntityVocabulary : SimpleVocabulary
    {
        public InventProductDefaultOrderSettingsEntityVocabulary()
        {
            VocabularyName = "Common Data Model InventProductDefaultOrderSettingsEntity";
            KeyPrefix = "commonDataModel.inventproductdefaultordersettingsentity";
            KeySeparator = ".";
            Grouping = "/InventProductDefaultOrderSettingsEntity";

            AddGroup("Common Data Model InventProductDefaultOrderSettingsEntity Details", group =>
            {
...
AreInventoryOrderPromisingDefaultsOverridden = group.Add(new VocabularyKey(nameof(AreInventoryOrderPromisingDefaultsOverridden), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
AreSalesOrderPromisingDefaultsOverridden = group.Add(new VocabularyKey(nameof(AreSalesOrderPromisingDefaultsOverridden), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
InventWarehouseId = group.Add(new VocabularyKey(nameof(InventWarehouseId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
public VocabularyKey AreSalesOrderPromisingDefaultsOverridden { get; private set; }
...
public VocabularyKey InventWarehouseId { get; private set; }
