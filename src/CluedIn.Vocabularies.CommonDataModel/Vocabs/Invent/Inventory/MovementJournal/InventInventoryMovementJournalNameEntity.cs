...
{
    public class InventInventoryMovementJournalNameEntityVocabulary : SimpleVocabulary
    {
        public InventInventoryMovementJournalNameEntityVocabulary()
        {
            VocabularyName = "Common Data Model InventInventoryMovementJournalNameEntity";
            KeyPrefix = "commonDataModel.inventinventorymovementjournalnameentity";
            KeySeparator = ".";
            Grouping = "/InventInventoryMovementJournalNameEntity";

            AddGroup("Common Data Model InventInventoryMovementJournalNameEntity Details", group =>
            {
                ...
                DefaultOffsetMainAccountId = group.Add(new VocabularyKey(nameof(DefaultOffsetMainAccountId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                DefaultOffsetMainAccountIdDisplayValue = group.Add(new VocabularyKey(nameof(DefaultOffsetMainAccountIdDisplayValue), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
        ...
        public VocabularyKey DefaultOffsetMainAccountId { get; private set; }
        public VocabularyKey DefaultOffsetMainAccountIdDisplayValue { get; private set; }
