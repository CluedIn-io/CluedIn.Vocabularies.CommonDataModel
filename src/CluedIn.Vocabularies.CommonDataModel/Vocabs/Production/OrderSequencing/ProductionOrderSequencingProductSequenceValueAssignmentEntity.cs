...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class ProductionOrderSequencingProductSequenceValueAssignmentEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Production Order Sequencing Product Sequence Value Assignment Entity";
            ...
            AddGroup("ProductionOrderSequencingProductSequenceValueAssignmentEntity Details", group =>
            {
