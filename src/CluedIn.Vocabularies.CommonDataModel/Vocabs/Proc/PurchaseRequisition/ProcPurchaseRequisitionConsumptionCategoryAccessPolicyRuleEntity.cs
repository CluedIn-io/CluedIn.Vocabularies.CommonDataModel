...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class ProcPurchaseRequisitionConsumptionCategoryAccessPolicyRuleEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Proc Purchase Requisition Consumption Category Access Policy Rule Entity";
            ...
            AddGroup("ProcPurchaseRequisitionConsumptionCategoryAccessPolicyRuleEntity Details", group =>
            {
