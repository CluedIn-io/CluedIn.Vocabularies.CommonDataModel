...
{
    public class ProjGrantV2EntityVocabulary : SimpleVocabulary
    {
...
CFDA = group.Add(new VocabularyKey(nameof(CFDA), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
GrantorAgency = group.Add(new VocabularyKey(nameof(GrantorAgency), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
...
public VocabularyKey CFDA { get; private set; }
public VocabularyKey GrantorAgency { get; private set; }
