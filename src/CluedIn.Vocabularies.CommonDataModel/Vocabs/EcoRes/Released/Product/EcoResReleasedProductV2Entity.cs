...
{
    public class EcoResReleasedProductV2EntityVocabulary : SimpleVocabulary
    {
        public EcoResReleasedProductV2EntityVocabulary()
        {
            VocabularyName = "Common Data Model EcoResReleasedProductV2Entity";
            KeyPrefix = "commonDataModel.ecoresreleasedproductv2entity";
            KeySeparator = ".";
            Grouping = "/EcoResReleasedProductV2Entity";

            AddGroup("Common Data Model EcoResReleasedProductV2Entity Details", group =>
            {
                ...
                ReservationHierarchyRecId = group.Add(new VocabularyKey(nameof(ReservationHierarchyRecId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                IsUnitCostProductVariantSpecific = group.Add(new VocabularyKey(nameof(IsUnitCostProductVariantSpecific), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                DefaultProductColorId = group.Add(new VocabularyKey(nameof(DefaultProductColorId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                DefaultProductSizeId = group.Add(new VocabularyKey(nameof(DefaultProductSizeId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                DefaultProductStyleId = group.Add(new VocabularyKey(nameof(DefaultProductStyleId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                DefaultProductVersionId = group.Add(new VocabularyKey(nameof(DefaultProductVersionId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                TaxGSTReliefCategorySales = group.Add(new VocabularyKey(nameof(TaxGSTReliefCategorySales), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                TaxGSTReliefCategoryInvent = group.Add(new VocabularyKey(nameof(TaxGSTReliefCategoryInvent), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                TaxGSTReliefCategoryPurch = group.Add(new VocabularyKey(nameof(TaxGSTReliefCategoryPurch), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                IsManualDiscountPOSRegistrationProhibited = group.Add(new VocabularyKey(nameof(IsManualDiscountPOSRegistrationProhibited), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                CustomsImportTariffCode = group.Add(new VocabularyKey(nameof(CustomsImportTariffCode), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                CustomsExportTariffCode = group.Add(new VocabularyKey(nameof(CustomsExportTariffCode), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                SATCode = group.Add(new VocabularyKey(nameof(SATCode), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ScaleIndicator = group.Add(new VocabularyKey(nameof(ScaleIndicator), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                CNPJ = group.Add(new VocabularyKey(nameof(CNPJ), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                TaxSubstitutionCode = group.Add(new VocabularyKey(nameof(TaxSubstitutionCode), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                UpdateProductVariantLifecycleState = group.Add(new VocabularyKey(nameof(UpdateProductVariantLifecycleState), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                CatchWeightItemHandlingPolicyName = group.Add(new VocabularyKey(nameof(CatchWeightItemHandlingPolicyName), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                IsRetailDiscountPOSRegistrationProhibited = group.Add(new VocabularyKey(nameof(IsRetailDiscountPOSRegistrationProhibited), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                IsTenderDiscountPOSRegistrationProhibited = group.Add(new VocabularyKey(nameof(IsTenderDiscountPOSRegistrationProhibited), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                RevRecBundle = group.Add(new VocabularyKey(nameof(RevRecBundle), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
        ...
        public VocabularyKey ReservationHierarchyRecId { get; private set; }
        ...
        public VocabularyKey IsUnitCostProductVariantSpecific { get; private set; }
        ...
        public VocabularyKey DefaultProductColorId { get; private set; }
        public VocabularyKey DefaultProductSizeId { get; private set; }
        public VocabularyKey DefaultProductStyleId { get; private set; }
        public VocabularyKey DefaultProductVersionId { get; private set; }
        ...
        public VocabularyKey TaxGSTReliefCategorySales { get; private set; }
        public VocabularyKey TaxGSTReliefCategoryInvent { get; private set; }
        public VocabularyKey TaxGSTReliefCategoryPurch { get; private set; }
        public VocabularyKey SADGroup { get; private set; }
        public VocabularyKey PKWiUCode { get; private set; }
        public VocabularyKey IsManualDiscountPOSRegistrationProhibited { get; private set; }
        ...
        public VocabularyKey CustomsImportTariffCode { get; private set; }
        public VocabularyKey CustomsExportTariffCode { get; private set; }
        public VocabularyKey SATCode { get; private set; }
        public VocabularyKey ScaleIndicator { get; private set; }
        public VocabularyKey CNPJ { get; private set; }
        public VocabularyKey TaxSubstitutionCode { get; private set; }
        public VocabularyKey ProductLifecycleStateId { get; private set; }
        public VocabularyKey UpdateProductVariantLifecycleState { get; private set; }
        public VocabularyKey CatchWeightItemHandlingPolicyName { get; private set; }
        ...
        public VocabularyKey IsRetailDiscountPOSRegistrationProhibited { get; private set; }
        public VocabularyKey IsTenderDiscountPOSRegistrationProhibited { get; private set; }
        ...
        public VocabularyKey RevRecBundle { get; private set; }
