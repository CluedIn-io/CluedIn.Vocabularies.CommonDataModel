...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class EcoResProductNumberIdentifiedReleasedProductVariantEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Eco Res Product Number Identified Released Product Variant Entity";
            ...
            AddGroup("EcoResProductNumberIdentifiedReleasedProductVariantEntity Details", group =>
            {
