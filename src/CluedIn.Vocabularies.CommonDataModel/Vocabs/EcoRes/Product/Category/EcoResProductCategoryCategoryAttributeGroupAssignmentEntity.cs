...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class EcoResProductCategoryCategoryAttributeGroupAssignmentEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Eco Res Product Category Category Attribute Group Assignment Entity";
            ...
            AddGroup("EcoResProductCategoryCategoryAttributeGroupAssignmentEntity Details", group =>
            {
