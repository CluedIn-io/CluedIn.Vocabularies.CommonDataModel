...
{
    public class PurchaseRequisitionLineEntityVocabulary : SimpleVocabulary
    {
        public PurchaseRequisitionLineEntityVocabulary()
        {
            VocabularyName = "Common Data Model PurchaseRequisitionLineEntity";
            KeyPrefix = "commonDataModel.purchaserequisitionlineentity";
            KeySeparator = ".";
            Grouping = "/PurchaseRequisitionLineEntity";

            AddGroup("Common Data Model PurchaseRequisitionLineEntity Details", group =>
            {
                RequisitionHeaderRecId = group.Add(new VocabularyKey(nameof(RequisitionHeaderRecId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                ProcurementProductCategoryHierarchyRecId = group.Add(new VocabularyKey(nameof(ProcurementProductCategoryHierarchyRecId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                PurchaseUnitOfMeasureRecId = group.Add(new VocabularyKey(nameof(PurchaseUnitOfMeasureRecId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                RequisitionerRecId = group.Add(new VocabularyKey(nameof(RequisitionerRecId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                ReceivingOperatingUnitRecId = group.Add(new VocabularyKey(nameof(ReceivingOperatingUnitRecId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ReceivingOperatingUnitNumber = group.Add(new VocabularyKey(nameof(ReceivingOperatingUnitNumber), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                BusinessJustificationRecId = group.Add(new VocabularyKey(nameof(BusinessJustificationRecId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                ProjectSalesUnitOfMeasureRecId = group.Add(new VocabularyKey(nameof(ProjectSalesUnitOfMeasureRecId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                FixedAssetReasonRecId = group.Add(new VocabularyKey(nameof(FixedAssetReasonRecId), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
        ...
        public VocabularyKey ProcurementProductCategoryHierarchyRecId { get; private set; }
        public VocabularyKey RequestedPurchaseQuantity { get; private set; }
        public VocabularyKey PurchaseUnitOfMeasureRecId { get; private set; }
        ...
        public VocabularyKey RequisitionerRecId { get; private set; }
        ...
        public VocabularyKey ReceivingOperatingUnitRecId { get; private set; }
        public VocabularyKey ReceivingOperatingUnitNumber { get; private set; }
        ...
        public VocabularyKey BusinessJustificationRecId { get; private set; }
        ...
        public VocabularyKey ProjectSalesUnitOfMeasureRecId { get; private set; }
        ...
        public VocabularyKey FixedAssetReasonRecId { get; private set; }
