...
{
    public class OpportunityLineTransactionVocabulary : SimpleVocabulary
    {
        public OpportunityLineTransactionVocabulary()
        {
            VocabularyName = "Opportunity Line Transaction";
            KeyPrefix = "commonDataModel.opportunitylinetransaction.projectserviceautomation";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.OpportunityLineTransaction;

            AddGroup("OpportunityLineTransaction Details for ProjectServiceAutomation", group =>
            {
			    OpportunityLineTransactionId = group.Add(new VocabularyKey(nameof(OpportunityLineTransactionId), "Opportunity Line Detail", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
        ...
        public VocabularyKey OpportunityLineTransactionId { get; private set; }
