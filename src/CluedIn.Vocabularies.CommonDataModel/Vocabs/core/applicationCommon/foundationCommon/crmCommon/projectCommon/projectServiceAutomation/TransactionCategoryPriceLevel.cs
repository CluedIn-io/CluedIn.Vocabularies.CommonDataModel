...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies.ProjectServiceAutomation
{
    public class TransactionCategoryPriceLevelVocabulary : SimpleVocabulary
    {
        public TransactionCategoryPriceLevelVocabulary()
        {
            ...
            KeySeparator = ".";
            Grouping = "/TransactionCategoryPriceLevel";

            AddGroup("TransactionCategoryPriceLevel Details for ProjectServiceAutomation", group =>
            {
			    TransactionCategoryPriceLevelId = group.Add(new VocabularyKey(nameof(TransactionCategoryPriceLevelId), "Transaction Category Price", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
