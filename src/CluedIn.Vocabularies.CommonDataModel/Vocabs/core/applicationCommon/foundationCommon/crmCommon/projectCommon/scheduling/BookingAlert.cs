...
namespace CluedIn.Vocabularies.CommonDataModel
{
    public class BookingAlertVocabulary : SimpleVocabulary
    {
        public BookingAlertVocabulary()
        {
            ...
            AddGroup("BookingAlert Details for Scheduling", group =>
            {
                ...
                ScheduledDurationMinutes = group.Add(new VocabularyKey(nameof(ScheduledDurationMinutes), "Estimated Duration", VocabularyKeyDataType.Integer, VocabularyKeyVisibility.Visible));
                ...
                RequiredAttendees = group.Add(new VocabularyKey(nameof(RequiredAttendees), "Assignees", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
            ...
            ///Property <see cref="ActivityId"/> from Vocab 'BookingAlertStatus.cdm.json/BookingAlertStatus' with Property 'BookingAlert'
            #endregion
        }
