...
{
    public class OrderLineTransactionVocabulary : SimpleVocabulary
    {
        public OrderLineTransactionVocabulary()
        {
            VocabularyName = "Order Line Transaction";
            KeyPrefix = "commonDataModel.orderlinetransaction.projectserviceautomation";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.OrderLineTransaction;

            AddGroup("OrderLineTransaction Details for ProjectServiceAutomation", group =>
            {
			    OrderLineTransactionId = group.Add(new VocabularyKey(nameof(OrderLineTransactionId), "Project contract line estimate", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
        ...
        public VocabularyKey OrderLineTransactionId { get; private set; }
