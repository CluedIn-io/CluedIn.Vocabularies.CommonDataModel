...
namespace CluedIn.Vocabularies.CommonDataModel
{
    ...
    {
        public ContactOnboardingFromProspectVocabulary()
        {
            VocabularyName = "Contact Onboarding From Prospect";
            KeyPrefix = "commonDataModel.contactonboardingfromprospect";
            KeySeparator = ".";
            ...
            AddGroup("ContactOnboardingFromProspect Details for Banking", group =>
            {
			    ...
			    BusinessProcessFlowInstanceId = group.Add(new VocabularyKey(nameof(BusinessProcessFlowInstanceId), "Contact Onboarding from Prospect", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
