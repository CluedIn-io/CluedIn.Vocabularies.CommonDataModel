...
{
    public class BusinessCheckingAccountVocabulary : SimpleVocabulary
    {
        public BusinessCheckingAccountVocabulary()
        {
            VocabularyName = "Business Checking Account";
            KeyPrefix = "commonDataModel.businesscheckingaccount";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.BusinessCheckingAccount;

            AddGroup("BusinessCheckingAccount Details for Banking", group =>
            {
			    ...
			    BusinessProcessFlowInstanceId = group.Add(new VocabularyKey(nameof(BusinessProcessFlowInstanceId), "Business Checking Account", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
