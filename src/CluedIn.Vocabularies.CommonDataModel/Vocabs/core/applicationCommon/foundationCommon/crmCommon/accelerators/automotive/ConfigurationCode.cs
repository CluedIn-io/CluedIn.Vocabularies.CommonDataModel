...
namespace CluedIn.Vocabularies.CommonDataModel
{
    public class ConfigurationCodeVocabulary : SimpleVocabulary
    {
        public ConfigurationCodeVocabulary()
        {
            ...
            KeyPrefix = "commonDataModel.configurationcode";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.ConfigurationCode;
            ...
            ///Property <see cref="ConfigurationCodeId"/> from Vocab 'ConfigurationOption.cdm.json/ConfigurationOption' with Property 'ConfigurationCodeId'
            ///Property <see cref="ConfigurationCodeId"/> from Vocab 'Specification.cdm.json/Specification' with Property 'ConfigurationCodeId'
            #endregion
        }
