...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies.ElectronicMedicalRecords
{
    public class ActivityDefinitionDynamicValueVocabulary : SimpleVocabulary
    {
        public ActivityDefinitionDynamicValueVocabulary()
        {
            ...
            KeySeparator = ".";
            Grouping = "/ActivityDefinitionDynamicValue";

            AddGroup("ActivityDefinitionDynamicValue Details for ElectronicMedicalRecords", group =>
            {
			    ...
			    ActivityDefinitionDynamicValueId = group.Add(new VocabularyKey(nameof(ActivityDefinitionDynamicValueId), "Activity Definition Dynamic Value", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
