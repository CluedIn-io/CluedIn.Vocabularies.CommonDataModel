...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies.ElectronicMedicalRecords
{
    public class RequestGroupDefinitionVocabulary : SimpleVocabulary
    {
        public RequestGroupDefinitionVocabulary()
        {
            ...
            KeySeparator = ".";
            Grouping = "/RequestGroupDefinition";

            AddGroup("RequestGroupDefinition Details for ElectronicMedicalRecords", group =>
            {
			    Definition = group.Add(new VocabularyKey(nameof(Definition), "Definition", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
        ...
        public VocabularyKey Definition { get; private set; }
        public VocabularyKey Name { get; private set; }
        public VocabularyKey RequestGroupDefinitionId { get; private set; }
