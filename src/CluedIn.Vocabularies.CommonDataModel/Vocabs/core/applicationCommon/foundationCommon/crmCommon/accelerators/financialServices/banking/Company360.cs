...
namespace CluedIn.Vocabularies.CommonDataModel.Banking
{
    public class Company360Vocabulary : SimpleVocabulary
    {
        public Company360Vocabulary()
        {
            ...
            AddGroup("Company360 Details for Banking", group =>
            {
			    ...
			    BusinessProcessFlowInstanceId = group.Add(new VocabularyKey(nameof(BusinessProcessFlowInstanceId), "Company 360", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
