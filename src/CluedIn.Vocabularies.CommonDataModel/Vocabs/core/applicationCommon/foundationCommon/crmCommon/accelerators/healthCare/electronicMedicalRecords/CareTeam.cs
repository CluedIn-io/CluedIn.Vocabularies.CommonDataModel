...
namespace CluedIn.Vocabularies.CommonDataModel
{
    public class CareTeamVocabulary : SimpleVocabulary
    {
        public CareTeamVocabulary()
        {
            ...
            ///Property <see cref="CareTeamId"/> from Vocab 'CarePlanCareTeam.cdm.json/CarePlanCareTeam' with Property 'CareTeamId'
            ///Property <see cref="CareTeamId"/> from Vocab 'CareTeamCategory.cdm.json/CareTeamCategory' with Property 'CareTeamId'
            ///Property <see cref="CareTeamId"/> from Vocab 'CareTeamManagingOrganization.cdm.json/CareTeamManagingOrganization' with Property 'CareTeamId'
            ///Property <see cref="CareTeamId"/> from Vocab 'CareTeamParticipant.cdm.json/CareTeamParticipant' with Property 'CareTeamId'
            ///Property <see cref="CareTeamId"/> from Vocab 'CareTeamParticipant.cdm.json/CareTeamParticipant' with Property 'MemberCareTeamId'
            ///Property <see cref="CareTeamId"/> from Vocab 'CareTeamReasonCode.cdm.json/CareTeamReasonCode' with Property 'CareTeamId'
            ///Property <see cref="CareTeamId"/> from Vocab 'CareTeamReasonReference.cdm.json/CareTeamReasonReference' with Property 'CareTeamId'
            ///Property <see cref="CareTeamId"/> from Vocab 'CommunicationRequestRecipient.cdm.json/CommunicationRequestRecipient' with Property 'RecipientCareTeamId'
            ///Property <see cref="CareTeamId"/> from Vocab 'EpisodeOfCareCareTeam.cdm.json/EpisodeOfCareCareTeam' with Property 'CareTeamMemberId'
            #endregion
        }
