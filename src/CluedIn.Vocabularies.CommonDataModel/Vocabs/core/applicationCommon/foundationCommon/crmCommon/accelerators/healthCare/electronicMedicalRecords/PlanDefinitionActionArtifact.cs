...
{
    public class PlanDefinitionActionArtifactVocabulary : SimpleVocabulary
    {
        public PlanDefinitionActionArtifactVocabulary()
        {
            VocabularyName = "Plan Definition Action Artifact";
            KeyPrefix = "commonDataModel.plandefinitionactionartifact.electronicmedicalrecords";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.PlanDefinitionActionArtifact;

            AddGroup("PlanDefinitionActionArtifact Details for ElectronicMedicalRecords", group =>
            {
			    ...
			    PlanDefinitionActionArtifactId = group.Add(new VocabularyKey(nameof(PlanDefinitionActionArtifactId), "Plan Definition Action Artifact", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
        ...
        public VocabularyKey PlanDefinitionActionArtifactId { get; private set; }
