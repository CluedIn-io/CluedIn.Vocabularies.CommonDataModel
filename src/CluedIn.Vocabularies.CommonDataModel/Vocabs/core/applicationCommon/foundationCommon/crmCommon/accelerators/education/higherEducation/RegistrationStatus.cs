...
namespace CluedIn.Vocabularies.CommonDataModel
{
    public class RegistrationStatusVocabulary : SimpleVocabulary
    {
        public RegistrationStatusVocabulary()
        {
            ...
            KeyPrefix = "commonDataModel.registrationstatus";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.RegistrationStatus;
            ...
            ///Property <see cref="RegistrationStatusId"/> from Vocab 'CourseHistory.cdm.json/CourseHistory' with Property 'RegistrationStatusId'
            #endregion
        }
