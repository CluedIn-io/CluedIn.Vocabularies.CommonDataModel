...
namespace CluedIn.Vocabularies.CommonDataModel.NonProfitForSales
{
    public class CampaignVocabulary : SimpleVocabulary
    {
        public CampaignVocabulary()
        {
            ...
            KeyPrefix = "commonDataModel.campaign.nonprofitforsales";
            KeySeparator = ".";
            ...
            ///Property <see cref="Campaign_DefaultDesignationId"/> to Vocab '/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Designation.cdm.json/Designation' with Property 'DesignationId'
            ...
            ///Property <see cref="CampaignId"/> from Vocab 'CreditPlan.cdm.json/CreditPlan' with Property 'CreditPlan_CampaignId'
            ///Property <see cref="CampaignId"/> from Vocab 'DesignationPlan.cdm.json/DesignationPlan' with Property 'DesignationPlan_CampaignId'
