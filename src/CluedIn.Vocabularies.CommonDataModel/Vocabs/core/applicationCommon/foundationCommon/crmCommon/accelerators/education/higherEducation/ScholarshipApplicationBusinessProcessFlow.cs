...
namespace CluedIn.Vocabularies.CommonDataModel
{
    ...
    {
        public ScholarshipApplicationBusinessProcessFlowVocabulary()
        {
            VocabularyName = "Scholarship Application Business Process Flow";
            KeyPrefix = "commonDataModel.scholarshipapplicationbusinessprocessflow";
            KeySeparator = ".";
            ...
            {
			    BusinessProcessFlowInstanceId = group.Add(new VocabularyKey(nameof(BusinessProcessFlowInstanceId), "Scholarship Application Business Process Flow", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
