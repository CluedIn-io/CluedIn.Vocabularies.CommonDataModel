...
{
    public class Customer360PersonVocabulary : SimpleVocabulary
    {
        public Customer360PersonVocabulary()
        {
            VocabularyName = "Customer 360 Person";
            KeyPrefix = "commonDataModel.customer360person.banking";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.Customer360Person;

            AddGroup("Customer360Person Details for Banking", group =>
            {
			    ...
			    BusinessProcessFlowInstanceId = group.Add(new VocabularyKey(nameof(BusinessProcessFlowInstanceId), "Customer 360 Person", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
