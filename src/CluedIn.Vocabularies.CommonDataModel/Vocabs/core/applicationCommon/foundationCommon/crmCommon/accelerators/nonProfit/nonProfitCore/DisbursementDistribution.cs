...
namespace CluedIn.Vocabularies.CommonDataModel
{
    public class DisbursementDistributionVocabulary : SimpleVocabulary
    {
        public DisbursementDistributionVocabulary()
        {
            ...
            KeyPrefix = "commonDataModel.disbursementdistribution";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.DisbursementDistribution;
            ...
            AddGroup("DisbursementDistribution Details for NonProfitIati", group =>
            {
