...
namespace CluedIn.Vocabularies.CommonDataModel
{
    public class MedicationAdministrationSupportingInformationVocabulary : SimpleVocabulary
    {
        public MedicationAdministrationSupportingInformationVocabulary()
        {
            ...
            KeyPrefix = "commonDataModel.medicationadministrationsupportinginformation";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.MedicationAdministrationSupportingInformation;
