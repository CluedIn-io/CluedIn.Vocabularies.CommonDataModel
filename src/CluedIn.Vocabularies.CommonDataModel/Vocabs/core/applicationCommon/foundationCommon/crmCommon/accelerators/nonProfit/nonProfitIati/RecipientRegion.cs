...
namespace CluedIn.Vocabularies.CommonDataModel.NonProfitIati
{
    public class RecipientRegionVocabulary : SimpleVocabulary
    {
        public RecipientRegionVocabulary()
        {
            ...
            ///Property <see cref="RegionId"/> to Vocab 'NonEmbeddedCodelist.cdm.json/NonEmbeddedCodelist' with Property 'NonEmbeddedCodelistId'
            ...
            ///Property <see cref="RecipientRegionId"/> from Vocab 'NarrativeTranslation.cdm.json/NarrativeTranslation' with Property 'RecipientRegion'
            #endregion
        }
