...
namespace CluedIn.Vocabularies.CommonDataModel.NonProfitIati
{
    public class MembershipCategoryVocabulary : SimpleVocabulary
    {
        public MembershipCategoryVocabulary()
        {
            ...
            KeyPrefix = "commonDataModel.membershipcategory.nonprofitiati";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.MembershipCategory;

            AddGroup("MembershipCategory Details for NonProfitIati", group =>
            {
