...
namespace CluedIn.Vocabularies.CommonDataModel
{
    public class IndicatorReferenceVocabulary : SimpleVocabulary
    {
        public IndicatorReferenceVocabulary()
        {
            ...
            KeyPrefix = "commonDataModel.indicatorreference";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.IndicatorReference;
            ...
            ///Property <see cref="IndicatorCodeId"/> to Vocab 'NonEmbeddedCodelist.cdm.json/NonEmbeddedCodelist' with Property 'NonEmbeddedCodelistId'
