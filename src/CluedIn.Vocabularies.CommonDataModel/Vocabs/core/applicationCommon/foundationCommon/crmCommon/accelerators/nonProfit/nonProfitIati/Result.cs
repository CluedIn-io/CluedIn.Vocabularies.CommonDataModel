...
namespace CluedIn.Vocabularies.CommonDataModel.NonProfitIati
{
    public class ResultVocabulary : SimpleVocabulary
    {
        public ResultVocabulary()
        {
            ...
            ///Property <see cref="ResultId"/> from Vocab 'NarrativeTranslation.cdm.json/NarrativeTranslation' with Property 'ResultId'
            ///Property <see cref="ResultId"/> from Vocab 'ResultReference.cdm.json/ResultReference' with Property 'ResultId'
