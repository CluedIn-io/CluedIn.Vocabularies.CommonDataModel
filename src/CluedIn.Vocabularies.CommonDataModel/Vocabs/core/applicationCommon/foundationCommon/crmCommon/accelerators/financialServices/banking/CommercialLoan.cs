...
{
    public class CommercialLoanVocabulary : SimpleVocabulary
    {
        public CommercialLoanVocabulary()
        {
            VocabularyName = "Commercial Loan";
            KeyPrefix = "commonDataModel.commercialloan.banking";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.CommercialLoan;

            AddGroup("CommercialLoan Details for Banking", group =>
            {
			    ...
			    BusinessProcessFlowInstanceId = group.Add(new VocabularyKey(nameof(BusinessProcessFlowInstanceId), "Commercial Loan", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
