...
namespace CluedIn.Vocabularies.CommonDataModel
{
    public class CompetitorAddressVocabulary : SimpleVocabulary
    {
        public CompetitorAddressVocabulary()
        {
            ...
            {
			    CompetitorAddressId = group.Add(new VocabularyKey(nameof(CompetitorAddressId), "Competitor Address", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
