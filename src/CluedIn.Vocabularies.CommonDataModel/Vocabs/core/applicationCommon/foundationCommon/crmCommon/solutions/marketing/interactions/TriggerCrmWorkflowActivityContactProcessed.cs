...
{
    public class TriggerCrmWorkflowActivityContactProcessedVocabulary : SimpleVocabulary
    {
        public TriggerCrmWorkflowActivityContactProcessedVocabulary()
        {
            VocabularyName = "Trigger Crm Workflow Activity Contact Processed";
            KeyPrefix = "commonDataModel.triggercrmworkflowactivitycontactprocessed.interactions";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.TriggerCrmWorkflowActivityContactProcessed;

            AddGroup("TriggerCrmWorkflowActivityContactProcessed Details for Interactions", group =>
            {
