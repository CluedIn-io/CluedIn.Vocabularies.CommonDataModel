...
{
    public class ActivityContactProcessingFailedVocabulary : SimpleVocabulary
    {
        public ActivityContactProcessingFailedVocabulary()
        {
            VocabularyName = "Activity Contact Processing Failed";
            KeyPrefix = "commonDataModel.activitycontactprocessingfailed.interactions";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.ActivityContactProcessingFailed;

            AddGroup("ActivityContactProcessingFailed Details for Interactions", group =>
            {
