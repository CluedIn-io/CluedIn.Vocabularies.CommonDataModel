...
namespace CluedIn.Vocabularies.CommonDataModel
{
    ...
    {
        public SplitterActivityContactProcessedVocabulary()
        {
            VocabularyName = "Splitter Activity Contact Processed";
            KeyPrefix = "commonDataModel.splitteractivitycontactprocessed";
            KeySeparator = ".";
        ...
        public VocabularyKey NextActivityId { get; private set; }
