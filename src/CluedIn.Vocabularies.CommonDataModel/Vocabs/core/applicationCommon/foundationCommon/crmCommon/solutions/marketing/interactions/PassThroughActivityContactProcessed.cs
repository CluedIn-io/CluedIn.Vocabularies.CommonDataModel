...
{
    public class PassThroughActivityContactProcessedVocabulary : SimpleVocabulary
    {
        public PassThroughActivityContactProcessedVocabulary()
        {
            VocabularyName = "Pass Through Activity Contact Processed";
            KeyPrefix = "commonDataModel.passthroughactivitycontactprocessed.interactions";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.PassThroughActivityContactProcessed;

            AddGroup("PassThroughActivityContactProcessed Details for Interactions", group =>
            {
