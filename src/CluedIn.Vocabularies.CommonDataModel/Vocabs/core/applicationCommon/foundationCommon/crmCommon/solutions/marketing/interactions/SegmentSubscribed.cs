...
{
    public class SegmentSubscribedVocabulary : SimpleVocabulary
    {
        public SegmentSubscribedVocabulary()
        {
            VocabularyName = "Segment Subscribed";
            KeyPrefix = "commonDataModel.segmentsubscribed.interactions";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.SegmentSubscribed;

            AddGroup("SegmentSubscribed Details for Interactions", group =>
            {
