...
{
    public class WebsiteClickedVocabulary : SimpleVocabulary
    {
        public WebsiteClickedVocabulary()
        {
            VocabularyName = "Website Clicked";
            KeyPrefix = "commonDataModel.websiteclicked.interactions";
            KeySeparator = ".";
            Grouping = CommonDataModelEntityTypes.WebsiteClicked;

            AddGroup("WebsiteClicked Details for Interactions", group =>
            {
			    ...
			    WebsiteId = group.Add(new VocabularyKey(nameof(WebsiteId), "Website ID", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
			    PageAddress = group.Add(new VocabularyKey(nameof(PageAddress), "Page address", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
			    ...
			    Link = group.Add(new VocabularyKey(nameof(Link), "Link", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
