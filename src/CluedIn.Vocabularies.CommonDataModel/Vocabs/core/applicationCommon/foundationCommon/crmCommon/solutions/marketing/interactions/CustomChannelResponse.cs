...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies.Interactions
{
    public class CustomChannelResponseVocabulary : SimpleVocabulary
    {
        public CustomChannelResponseVocabulary()
        {
            ...
            KeySeparator = ".";
            Grouping = "/CustomChannelResponse";

            AddGroup("CustomChannelResponse Details for Interactions", group =>
            {
			    ...
			    EntityId = group.Add(new VocabularyKey(nameof(EntityId), "Entity ID", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
			    EntityType = group.Add(new VocabularyKey(nameof(EntityType), "Entity type", VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible)); 
