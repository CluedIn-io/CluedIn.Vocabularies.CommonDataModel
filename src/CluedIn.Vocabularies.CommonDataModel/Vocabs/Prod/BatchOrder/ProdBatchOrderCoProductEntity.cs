...
{
    public class ProdBatchOrderCoProductEntityVocabulary : SimpleVocabulary
    {
        public ProdBatchOrderCoProductEntityVocabulary()
        {
            VocabularyName = "Prod Batch Order Co Product Entity";
            ...
            AddGroup("ProdBatchOrderCoProductEntity Details", group =>
            {
                ...
                CoProductQuantity = group.Add(new VocabularyKey(nameof(CoProductQuantity), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                CoProductQuantityDenominator = group.Add(new VocabularyKey(nameof(CoProductQuantityDenominator), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                CoProductBatchOrderNumber = group.Add(new VocabularyKey(nameof(CoProductBatchOrderNumber), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                EstimatedCoProductQuantity = group.Add(new VocabularyKey(nameof(EstimatedCoProductQuantity), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                StartedCoProductQuantity = group.Add(new VocabularyKey(nameof(StartedCoProductQuantity), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                EndedDate = group.Add(new VocabularyKey(nameof(EndedDate), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                RemainingCoProductQuantity = group.Add(new VocabularyKey(nameof(RemainingCoProductQuantity), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                RoundingUpMultiplesCoProductQuantity = group.Add(new VocabularyKey(nameof(RoundingUpMultiplesCoProductQuantity), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
        ...
        public VocabularyKey CoProductQuantity { get; private set; }
        public VocabularyKey CoProductQuantityDenominator { get; private set; }
        ...
        public VocabularyKey CoProductBatchOrderNumber { get; private set; }
        public VocabularyKey ProductionType { get; private set; }
        public VocabularyKey EstimatedCoProductQuantity { get; private set; }
        public VocabularyKey StartedCoProductQuantity { get; private set; }
        public VocabularyKey EndedDate { get; private set; }
        public VocabularyKey RemainingCoProductQuantity { get; private set; }
        ...
        public VocabularyKey RoundingUpMultiplesCoProductQuantity { get; private set; }
