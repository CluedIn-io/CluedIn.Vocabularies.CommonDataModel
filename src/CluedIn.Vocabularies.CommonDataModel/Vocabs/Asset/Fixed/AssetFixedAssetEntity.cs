...
{
    public class AssetFixedAssetEntityVocabulary : SimpleVocabulary
    {
        public AssetFixedAssetEntityVocabulary()
        {
            VocabularyName = "Common Data Model AssetFixedAssetEntity";
            KeyPrefix = "commonDataModel.assetfixedassetentity";
            KeySeparator = ".";
            Grouping = "/AssetFixedAssetEntity";

            AddGroup("Common Data Model AssetFixedAssetEntity Details", group =>
            {
                ...
                ActivityCodeDescription = group.Add(new VocabularyKey(nameof(ActivityCodeDescription), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                AssetConditionDescription = group.Add(new VocabularyKey(nameof(AssetConditionDescription), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                AssetLocationName = group.Add(new VocabularyKey(nameof(AssetLocationName), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                MajorTypeDescription = group.Add(new VocabularyKey(nameof(MajorTypeDescription), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                PropertyGroup = group.Add(new VocabularyKey(nameof(PropertyGroup), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                PropertyGroupDescription = group.Add(new VocabularyKey(nameof(PropertyGroupDescription), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                SortField1Sorting = group.Add(new VocabularyKey(nameof(SortField1Sorting), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                SortField1Description = group.Add(new VocabularyKey(nameof(SortField1Description), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                SortField2Id = group.Add(new VocabularyKey(nameof(SortField2Id), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                SortField2Sorting = group.Add(new VocabularyKey(nameof(SortField2Sorting), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                SortField2Description = group.Add(new VocabularyKey(nameof(SortField2Description), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                SortField3Id = group.Add(new VocabularyKey(nameof(SortField3Id), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                SortField3Sorting = group.Add(new VocabularyKey(nameof(SortField3Sorting), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                SortField3Description = group.Add(new VocabularyKey(nameof(SortField3Description), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
        ...
        public VocabularyKey ActivityCodeDescription { get; private set; }
        public VocabularyKey AssetConditionId { get; private set; }
        public VocabularyKey AssetConditionDescription { get; private set; }
        ...
        public VocabularyKey AssetLocationName { get; private set; }
        ...
        public VocabularyKey MajorTypeDescription { get; private set; }
        ...
        public VocabularyKey PropertyGroup { get; private set; }
        public VocabularyKey PropertyGroupId { get; private set; }
        public VocabularyKey PropertyGroupDescription { get; private set; }
        ...
        public VocabularyKey SortField1Sorting { get; private set; }
        public VocabularyKey SortField1Description { get; private set; }
        public VocabularyKey SortField2Id { get; private set; }
        public VocabularyKey SortField2Sorting { get; private set; }
        public VocabularyKey SortField2Description { get; private set; }
        public VocabularyKey SortField3Id { get; private set; }
        public VocabularyKey SortField3Sorting { get; private set; }
        public VocabularyKey SortField3Description { get; private set; }
