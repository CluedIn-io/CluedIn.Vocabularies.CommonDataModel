...
{
    public class BOMBillOfMaterialsJournalNameEntityVocabulary : SimpleVocabulary
    {
        public BOMBillOfMaterialsJournalNameEntityVocabulary()
        {
            VocabularyName = "Common Data Model BOMBillOfMaterialsJournalNameEntity";
            KeyPrefix = "commonDataModel.bombillofmaterialsjournalnameentity";
            KeySeparator = ".";
            Grouping = "/BOMBillOfMaterialsJournalNameEntity";

            AddGroup("Common Data Model BOMBillOfMaterialsJournalNameEntity Details", group =>
            {
