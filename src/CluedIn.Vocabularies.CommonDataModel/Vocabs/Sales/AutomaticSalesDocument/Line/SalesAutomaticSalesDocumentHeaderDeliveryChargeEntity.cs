...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class SalesAutomaticSalesDocumentHeaderDeliveryChargeEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Sales Automatic Sales Document Header Delivery Charge Entity";
            ...
            AddGroup("SalesAutomaticSalesDocumentHeaderDeliveryChargeEntity Details", group =>
            {
