...
{
    public class SalesFormletterSalesQuotationFormPrintingConfigurationEntityVocabulary : SimpleVocabulary
    {
        public SalesFormletterSalesQuotationFormPrintingConfigurationEntityVocabulary()
        {
            VocabularyName = "Common Data Model SalesFormletterSalesQuotationFormPrintingConfigurationEntity";
            ...
            AddGroup("Common Data Model SalesFormletterSalesQuotationFormPrintingConfigurationEntity Details", group =>
            {
                ...
                InventDimQuotation = group.Add(new VocabularyKey(nameof(InventDimQuotation), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
        ...
        public VocabularyKey InventDimQuotation { get; private set; }
