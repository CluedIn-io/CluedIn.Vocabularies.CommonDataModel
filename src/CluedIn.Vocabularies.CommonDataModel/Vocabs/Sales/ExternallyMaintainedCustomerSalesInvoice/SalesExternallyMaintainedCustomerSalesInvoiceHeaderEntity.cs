...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class SalesExternallyMaintainedCustomerSalesInvoiceHeaderEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Sales Externally Maintained Customer Sales Invoice Header Entity";
            ...
            AddGroup("SalesExternallyMaintainedCustomerSalesInvoiceHeaderEntity Details", group =>
            {
