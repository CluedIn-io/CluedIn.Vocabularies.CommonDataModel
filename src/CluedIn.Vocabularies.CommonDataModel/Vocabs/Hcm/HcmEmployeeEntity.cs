...
{
    public class HcmEmployeeEntityVocabulary : SimpleVocabulary
    {
        public HcmEmployeeEntityVocabulary()
        {
            VocabularyName = "Common Data Model HcmEmployeeEntity";
            KeyPrefix = "commonDataModel.hcmemployeeentity";
            KeySeparator = ".";
            Grouping = "/HcmEmployeeEntity";

            AddGroup("Common Data Model HcmEmployeeEntity Details", group =>
            {
                ...
                PensionEnrollment = group.Add(new VocabularyKey(nameof(PensionEnrollment), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                PensionStart = group.Add(new VocabularyKey(nameof(PensionStart), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                ...
                RelocationReimbursement = group.Add(new VocabularyKey(nameof(RelocationReimbursement), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                EmployeeDetailsEffective = group.Add(new VocabularyKey(nameof(EmployeeDetailsEffective), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
                EmployeeDetailsExpiration = group.Add(new VocabularyKey(nameof(EmployeeDetailsExpiration), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
        ...
        public VocabularyKey PensionEnrollment { get; private set; }
        public VocabularyKey PensionStart { get; private set; }
        public VocabularyKey ProbationPeriod { get; private set; }
        public VocabularyKey RelocationReimbursement { get; private set; }
        public VocabularyKey EmployeeDetailsEffective { get; private set; }
        public VocabularyKey EmployeeDetailsExpiration { get; private set; }
