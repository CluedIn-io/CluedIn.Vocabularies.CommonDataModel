...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class VendProspectiveVendorRegistrationProcurementCategoryEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Vend Prospective Vendor Registration Procurement Category Entity";
            ...
            AddGroup("VendProspectiveVendorRegistrationProcurementCategoryEntity Details", group =>
            {
