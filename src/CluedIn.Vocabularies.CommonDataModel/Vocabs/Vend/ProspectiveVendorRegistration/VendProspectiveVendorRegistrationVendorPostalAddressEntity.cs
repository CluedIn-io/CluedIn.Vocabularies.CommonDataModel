...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class VendProspectiveVendorRegistrationVendorPostalAddressEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Vend Prospective Vendor Registration Vendor Postal Address Entity";
            ...
            AddGroup("VendProspectiveVendorRegistrationVendorPostalAddressEntity Details", group =>
            {
