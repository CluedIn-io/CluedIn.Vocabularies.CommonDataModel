...
{
    public class RetailPosBatchEntityVocabulary : SimpleVocabulary
    {
        public RetailPosBatchEntityVocabulary()
        {
            VocabularyName = "Common Data Model RetailPosBatchEntity";
            KeyPrefix = "commonDataModel.retailposbatchentity";
            KeySeparator = ".";
            Grouping = "/RetailPosBatchEntity";

            AddGroup("Common Data Model RetailPosBatchEntity Details", group =>
            {
                ...
                HasPendingOfflineTransactions = group.Add(new VocabularyKey(nameof(HasPendingOfflineTransactions), VocabularyKeyDataType.Text, VocabularyKeyVisibility.Visible));
        ...
        public VocabularyKey HasPendingOfflineTransactions { get; private set; }
