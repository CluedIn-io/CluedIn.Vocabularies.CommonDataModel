...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class WrkCtrSiteSpecificOperationsResourceSchedulingParametersEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Wrk Ctr Site Specific Operations Resource Scheduling Parameters Entity";
            ...
            AddGroup("WrkCtrSiteSpecificOperationsResourceSchedulingParametersEntity Details", group =>
            {
