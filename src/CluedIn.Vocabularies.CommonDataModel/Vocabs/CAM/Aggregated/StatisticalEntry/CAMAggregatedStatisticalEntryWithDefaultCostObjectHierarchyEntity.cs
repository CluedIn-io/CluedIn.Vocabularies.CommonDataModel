...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class CAMAggregatedStatisticalEntryWithDefaultCostObjectHierarchyEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "CAM Aggregated Statistical Entry With Default Cost Object Hierarchy Entity";
            ...
            AddGroup("CAMAggregatedStatisticalEntryWithDefaultCostObjectHierarchyEntity Details", group =>
            {
