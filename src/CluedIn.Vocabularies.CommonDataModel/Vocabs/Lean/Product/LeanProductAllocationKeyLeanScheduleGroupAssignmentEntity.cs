...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class LeanProductAllocationKeyLeanScheduleGroupAssignmentEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Lean Product Allocation Key Lean Schedule Group Assignment Entity";
            ...
            AddGroup("LeanProductAllocationKeyLeanScheduleGroupAssignmentEntity Details", group =>
            {
