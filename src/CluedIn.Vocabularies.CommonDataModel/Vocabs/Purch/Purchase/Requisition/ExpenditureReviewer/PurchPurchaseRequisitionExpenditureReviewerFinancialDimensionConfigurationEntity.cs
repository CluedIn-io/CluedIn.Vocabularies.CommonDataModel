...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class PurchPurchaseRequisitionExpenditureReviewerFinancialDimensionConfigurationEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Purch Purchase Requisition Expenditure Reviewer Financial Dimension Configuration Entity";
            ...
            AddGroup("PurchPurchaseRequisitionExpenditureReviewerFinancialDimensionConfigurationEntity Details", group =>
            {
