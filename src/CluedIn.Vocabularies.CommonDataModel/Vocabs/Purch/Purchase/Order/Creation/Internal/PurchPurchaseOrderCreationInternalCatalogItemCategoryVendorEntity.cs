...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class PurchPurchaseOrderCreationInternalCatalogItemCategoryVendorEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Purch Purchase Order Creation Internal Catalog Item Category Vendor Entity";
            ...
            AddGroup("PurchPurchaseOrderCreationInternalCatalogItemCategoryVendorEntity Details", group =>
            {
