...
{
    public class PurchPurchaseOrderCreationExternalCatalogItemCategoryVendorEntityVocabulary : SimpleVocabulary
    {
        public PurchPurchaseOrderCreationExternalCatalogItemCategoryVendorEntityVocabulary()
        {
            VocabularyName = "Purch Purchase Order Creation External Catalog Item Category Vendor Entity";
