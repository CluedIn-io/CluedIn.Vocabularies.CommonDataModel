...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class PurchFormletterRequestForQuotationFormPrintingConfigurationEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Purch Formletter Request For Quotation Form Printing Configuration Entity";
            ...
            AddGroup("PurchFormletterRequestForQuotationFormPrintingConfigurationEntity Details", group =>
            {
