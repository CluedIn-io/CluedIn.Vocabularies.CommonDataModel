...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class PurchFormletterPurchaseInquiryFormPrintingConfigurationEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Purch Formletter Purchase Inquiry Form Printing Configuration Entity";
            ...
            AddGroup("PurchFormletterPurchaseInquiryFormPrintingConfigurationEntity Details", group =>
            {
