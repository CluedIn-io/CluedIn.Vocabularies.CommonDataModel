...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class PurchDemandConsolidationNonCatalogItemCategoryVendorEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Purch Demand Consolidation Non Catalog Item Category Vendor Entity";
            ...
            AddGroup("PurchDemandConsolidationNonCatalogItemCategoryVendorEntity Details", group =>
            {
