...
namespace CluedIn.Crawling.CommonDataModel.Vocabularies
{
    public class PurchDemandConsolidationInternalCatalogItemCategoryVendorEntityVocabulary : SimpleVocabulary
    {
        ...
        {
            VocabularyName = "Purch Demand Consolidation Internal Catalog Item Category Vendor Entity";
            ...
            AddGroup("PurchDemandConsolidationInternalCatalogItemCategoryVendorEntity Details", group =>
            {
